...
namespace MarioApp2025
{
    ...
    {
        static readonly string ademicoUrl = MyApiSecrets.testUrl;
        static readonly string accessToken = MyApiSecrets.testAccessToken;
        static readonly string username = MyApiSecrets.testUsername;
        static readonly string password = MyApiSecrets.testPassword;
