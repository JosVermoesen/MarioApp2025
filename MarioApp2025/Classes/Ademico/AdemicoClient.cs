...
namespace MarioApp2025
{
    ...
    {
        static readonly string ademicoUrl = MySqlSecrets.testUrl;
        static readonly string accessToken = MySqlSecrets.testAccessToken;
        static readonly string username = MySqlSecrets.testUsername;
        static readonly string password = MySqlSecrets.testPassword;
